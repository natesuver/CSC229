...
public class FlyDriveFrame extends JFrame implements ActionListener {
   ...
   public FlyDriveFrame() {
     ...
     // distField = new JTextField();
      ...
      distField.setText("0");
      distField.setColumns(10); // Initial width of 10 units 
   ...
   public void actionPerformed(ActionEvent event) {
     ...
     // String enteredValue = distField.getText();
    //  var result = Double.parseDouble(enteredValue);
      
     // totMiles = ((Number) distField.getText()).doubleValue();
     // totMiles = result;
